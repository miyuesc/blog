...
![img](../images/1b6e9f15d14c452f8b5f4a59a3d3add8tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/7fea3a531fab498e8ca7a1daace8038btplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

[试一下](https://www.typescriptlang.org/zh/play?#code/C4TwDgpgBA4hwDUCGAbArhAKuCAeACgHxQC8U+UEAHsBAHYAmAzuQE4D2AtgJZN7d0AZhFZRk6CMQD8Y1BigAuKHQgA3EQG4AUDtCRY8cRgBKEJmhTBSBxHKw4CHHn1wByAOZokdd68KENIA)
...
![img](../images/189a8a20ed5c4f60905bc88ca9ba61bbtplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

当类型参数 Arr 为 [] 时：

![img](../images/ff00e79903474f01b522fc95b4189096tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

[试一下](https://www.typescriptlang.org/zh/play?#code/C4TwDgpgBA4hwDECWAnAzsAPAQRSqEAHsBAHYAmaUArqQNakD2A7qQNoC6AfFALxS58REhSpskpAGYR8ydMAA0UAHSraDFuw4coAfihyMUAFxRSEAG4yA3ACh7oSLHiHgAJQhpqAG2B9niKgYmGwAjAoATAoAzNx2to7QcIHyHl6+Ef7JriFxtkA)
...
![img](../images/959e27b8dbfd420182d8bcac575c6d5btplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/cd533ba9b9a2431287b1c8d12f02e6dftplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

当类型参数 Arr 为 [] 时：

![img](../images/22a64419e01a47f49ca4dc0d60bc8510tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/a1c5bb5c645a472ba143b4c4787e972atplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/891a3c57dc8b4a9581883b05d58ced38tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

不匹配时：

![img](../images/73e3eaa47b924f9ca4e837042a12650ctplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/2cd97d2e01ec4749bd80ab520d1733fftplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

不匹配时：

![img](../images/41c48e63dc6240dfa481dd256c89a9e0tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/df89e8af4ccb4d868cae790b82d10fbctplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/c44ef0a46e514a3588b220e23752da8dtplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/332a738fff064ba58b073d1e03539275tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/b1dd929580e34c77afc6265886ee43f4tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/4539c7a0a01c43a7837908c6397bcbfctplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/75229ba1521c42d1940c441e6e0ee0d5tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/a0fef176aec24e27ad2513b9a04afaa7tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/9c8247dad58d4a0cbf2d1b2701908a45tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/e3bde943e699415fab2be6e6aeeeb454tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/0db834880b4c4ca6a6e22c894eaa4209tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/33c5fa6ffe7a4fda85230e5b363e0d5ctplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)
...
![img](../images/580bf3bf266f42c69b268d96a3fb09betplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

在 ts3.0 里面如果没有对应的索引，`Obj[Key]` 返回的是 `{}` 而不是 `never`，所以这样做下兼容处理。

如果有 `ref` 这个索引的话，就通过 `infer` 提取 `Value` 的类型返回，否则返回 `never`。

![img](../images/71790e667fba43759068d72d2f44f234tplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

当 ref 为 `undefined` 时：

![img](../images/08aa267ecaaf461a959bcb83230352fetplv-k3u1fbpfcp-zoom-in-crop-mark1304000.awebp)

[试一下](https://www.typescriptlang.org/zh/play?ts=4.5.0-beta#code/C4TwDgpgBA4hwCUIDMAKAnA9mAzgHg2xwD4oBeKAKChqgHJ0U6oIAPYCAOwBMcoBrCCEzIohXNVpSA-GKy4W7LrygBvKI2TSAXFACWnZBHRQAagEMANgFdoAHyjWeKAxG4BfSVO9RZFmxBePrS6nBAAbsZBUqERxgDclJSgkLDwSGjyOEh8FHCIKOL46po6UACMADRQnOYAthC6dNyYnADmdO7Eicng0PkZRTkATORpBZlEeCUoZU7cLmHc1bUNTS3tnd2UQA)
