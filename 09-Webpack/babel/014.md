...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cd13aec3a6d74708b4807f669e74edf7~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/71d1a8392dd348c1b890fccf7b50464b~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/baf68934cf8543f3925546bc74d0c58e~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/42b7becf2d2048758718032eadd7f646~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

现在变成了这样：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/04e28edb87a54c1bb479d36828f942be~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/60985675a0e44113beb78576353e565a~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

同样有全局引入和重复注入的问题。

引入 transform-runtime 插件之后是这样的：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c6b5bcc1230746a88dbba3e7699160d0~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/26d7fd0fba0746fb9f416f710b73a041~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/253ce602fe244004a85e59c2f8323d0c~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d560d2ed10804517ae5a7e53b85b27a8~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

然后根据 @babel/compact-data 的数据来过滤出这些浏览器支持的语法和 api：

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a79791ff53364348a24f7920530a72e9~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

然后去掉这些已经支持的语法和 api 对应的插件，剩下的就是需要用的转换插件：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dfcaf484cfe84039b4c56f3d22d6f01f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/df22c92aad76406facf59ac9de433762~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a6475b7778e14fdd9da9931dc5fbe047~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/81e265d7b97b4b0294a9eb5534dffcdd~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
这个其实是已知问题，可以在 babel 的项目里找到这个 [issue](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fbabel%2Fbabel%2Fissues%2F10008 "https://github.com/babel/babel/issues/10008")：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/89df44e70bc74878ac44567316dc4d37~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
